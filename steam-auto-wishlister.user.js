...
// @updateURL    https://github.com/FiveElementNinja/Steam-Auto-Wishlister/raw/master/steam-auto-wishlister.user.js
// @downloadURL  https://github.com/FiveElementNinja/Steam-Auto-Wishlister/raw/master/steam-auto-wishlister.user.js
// @grant        none
// @run-at       document-end
// ==/UserScript==
...
console.log('Steam Auto-Wishlister -- Loaded');
...
(function () {
    ...
    if (category_icons) {
        ...
        for (var i=0; i < category_icons.length; i++) {
            if (category_icons[i].src && category_icons[i].src.match('ico_cards')) {
                has_cards = true;
                break;
            }
        ...
        if (has_cards && !is_free && !is_dlc) {
            console.log('Steam Auto-Wishlister -- This app has cards. Adding to Wishlist.');
            ...
            if (wishlist_area && wishlist_area.firstElementChild && wishlist_area.firstElementChild.href && wishlist_area.firstElementChild.href != '' && wishlist_area.firstElementChild.href.indexOf('javascript:AddToWishlist(') === 0) {
                try {
                    ...
                    console.log('Steam Auto-Wishlister -- Error adding to Wishlist. Try reloading the page.');
                }
            } else {
                console.log('Steam Auto-Wishlister -- This app is already on your Wishlist or there was an error.');
            }
        } else {
            console.log('Steam Auto-Wishlister -- This app does not have cards.');
        }
    } else {
        console.log('Steam Auto-Wishlister -- Script error.');
    }
}());